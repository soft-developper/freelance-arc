 ...
 */
export declare function transfer<config extends Config>(config: config, parameters: transfer.Parameters<config>): Promise<transfer.ReturnValue>;
export declare namespace transfer {
    type Parameters<config extends Config> = UnionCompute<ChainIdParameter<config> & ConnectorParameter & AccountParameter & Actions.wallet.transfer.Parameters>;
    type ReturnValue = Actions.wallet.transfer.ReturnValue;
    type ErrorType = GetConnectorClientErrorType | BaseErrorType | Actions.wallet.transfer.ErrorType;
}
/**
